(function () {
    ...
    angular
        ...
        .directive('easpaybFile', easpaybFile);
    ...
    function FileController($scope, alertasServicios, $log, serviciosRest, tamanioPDF, tamanioIMG,
        ...
        /**
         * @ngdoc method
         * @name eAspayb.easpaybFile#getRandomId
         * @methodOf eAspayb.directive:easpaybFile
        ...
        /**
         * @ngdoc method
         * @name eAspayb.easpaybFile#actualizar
         * @methodOf eAspayb.directive:easpaybFile
        ...
        /**
         * @ngdoc method
         * @name eAspayb.easpaybFile#limpiar
         * @methodOf eAspayb.directive:easpaybFile
    ...
    function easpaybFile() {
        return {
            ...
            templateUrl: 'Xpertys/xsDirectivas/easpaybFile/easpaybFile.html'
        };
    }
})
();